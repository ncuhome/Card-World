...
public class Character : MonoBehaviour
{
    ...
    public void AddAge()
    {
        ...
        {
            ageSpeed = 1f + (BlockSystem.Instance.blocks[item.blockNum].water * BlockSystem.Instance.blocks[item.blockNum].temperature
            * BlockSystem.Instance.blocks[item.blockNum].livability * 0.01f) / (BlockSystem.Instance.blocks[item.blockNum].water + BlockSystem.Instance.blocks[item.blockNum].temperature) - 1;
        }
        else
        {
            ageSpeed = 0.5f + (BlockSystem.Instance.blocks[item.blockNum].water * BlockSystem.Instance.blocks[item.blockNum].temperature
            * BlockSystem.Instance.blocks[item.blockNum].livability * 0.01f) / (BlockSystem.Instance.blocks[item.blockNum].water + BlockSystem.Instance.blocks[item.blockNum].temperature) - 1;
        }
